CREATE OR REPLACE VIEW pbp.defense_success_2023
 AS
 WITH raw_data AS (
 ...
 SELECT raw_data.week,
   ...
   FROM raw_data
  GROUP BY raw_data.week, raw_data.game_id, raw_data.defteam, raw_data.down, raw_data.play_type, raw_data.run_location, raw_data.pass_location, raw_data.pass_length
  ORDER BY raw_data.week, raw_data.defteam;